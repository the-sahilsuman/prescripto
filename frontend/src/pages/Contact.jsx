    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row justify-center gap-10 mb-28 text-sm '>
        ...
        <div className='flex flex-col justify-center items-start gap-6 '>
          ...
          <p className='text-gray-500'>Tel: (415)555-0132 <br /> Email: prescripto@info.in</p>
          <p className='font-semibold text-lg text-gray-600'>CARRERS AT PRESCRIPTO</p>
          <p className='text-gray-500'>Learn more about our teams and job openings.</p>
          <button className='border border-black text-sm px-8 py-4 hover:bg-black hover:text-white transition-all durantion-500 cursor-pointer'>Explore Jobs</button>
        </div>
      </div>
